<html>
    ...
    <body background="all.jpg" style="background-repeat:no-repeat;width:30%;height:50%;background-size:100% 100%">
        <div><img src="driverlogo.png" style="width:100px;height: 100px;border-radius: 15px;
                         font-size: 200px;">
